      ...
      <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((p) => (
          ...
          >
            ...
            <h2 className="mt-2 text-h4 font-semibold text-[color:var(--color-text-primary)]">
              {p.title}
            </h2>
            {p.excerpt && (
              <p className="mt-2 text-small text-[color:var(--color-text-muted)]">{p.excerpt}</p>
            )}
            <p className="mt-3 text-overline text-[color:var(--color-text-muted)]">
