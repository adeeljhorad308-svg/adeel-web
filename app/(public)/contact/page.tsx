    ...
    <main id="main-content" className="mx-auto max-w-content-xl px-5 py-24 lg:px-8">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
        <div className="lg:col-span-5">
          <h1 className="font-display text-h1 font-bold text-[color:var(--color-text-primary)]">Get in touch</h1>
          <p className="mt-4 text-body-lg text-[color:var(--color-text-muted)]">Tell us about your project — we reply within 24 hours.</p>
